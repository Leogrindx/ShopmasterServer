...
class Module {
    add(table, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            values (${value.map((e, i) => `$${i+1}`).join(',')})`;
                console.log(sql);
                yield db.query(sql, value.map(e => e.value));
                return true;
            }
            catch (e) {
                console.error(e);
    ...
    getOne(table, column, valueSearch) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const getItem = yield db.query(`SELECT * FROM ${table} WHERE ${column} = $1 `, [valueSearch]);
    ...
    update(table, columnSET, valueSet, valueSearch, columnSerach, returning) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
